...
print(f"  2. Go to Home page")
print(f"  3. Upload these 3 files from data/demo/:")
print(f"     - {cow_id}_sensor_data.csv")
print(f"     - {cow_id}_alerts.json")
print(f"     - {cow_id}_metadata.json")
print(f"  4. Click 'Refresh to Load Data'")
print(f"  5. Explore the dashboard!")
